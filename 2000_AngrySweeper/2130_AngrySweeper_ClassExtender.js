...
class Info extends InfoBase {
    ...
    preshow() {
        ...
        this.td[2][0].innerText = "Push";
        this.td[3][0].innerText = charaSymbol[charaNum.hide];
        this.td[4][0].innerText = charaSymbol[charaNum.flag];
        this.td[5][0].innerText = charaSymbol[charaNum.check];
    }
    
    show(dataToShow) {
        this.td[0][1].innerText = dataToShow.cSize;
        this.td[1][1].innerText = dataToShow.numOfAngry;
        this.td[2][1].innerText = dataToShow.countOfPush;
        this.td[3][1].innerText = dataToShow.numOfHide;
        this.td[4][1].innerText = dataToShow.numOfFlag;
        this.td[5][1].innerText = dataToShow.numOfCheck;
    }
